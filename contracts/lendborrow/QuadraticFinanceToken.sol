...
contract QuadraticFinanceToken is ERC20,Ownable {
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        IQuadraticLendCompound(owner()).doAfterLpTransfer(address(this),msg.sender,recipient,amount);
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        IQuadraticLendCompound(owner()).doAfterLpTransfer(address(this),sender,recipient,amount);
