...
contract QuadraticLendCompound is IQuadraticLendCompoundStorage,RoleControl,Initializable {
    ...
    function doInitialize(IQuadraticBorrowCompound _borrowCompound,uint256 _maxBorrowRate,uint256 _interestPlatformRate) public initializer{
