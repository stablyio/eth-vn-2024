...
import type {
  QuadraticAuction,
  QuadraticAuctionInterface,
} from "../../../contracts/auction/QuadraticAuction";
...
type QuadraticAuctionConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: QuadraticAuctionConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class QuadraticAuction__factory extends ContractFactory {
  constructor(...args: QuadraticAuctionConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): QuadraticAuction__factory {
    return super.connect(runner) as QuadraticAuction__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): QuadraticAuctionInterface {
    return new Interface(_abi) as QuadraticAuctionInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): QuadraticAuction {
    return new Contract(address, _abi, runner) as unknown as QuadraticAuction;
  }
}
