...
contract QuadraticAuction is RoleControl,IQuadraticBorrowCompoundStorage,Initializable{
    ...
    event SetQuadraticLiquidationEvent(address sender,address quadraticLiquidation);
    ...
    function doInitialize(IQuadraticBorrowCompound _borrowCompound,IUniswapV3Oracle _uniswapV3Oracle,uint256 _reductionTime,uint256 _reductionRatio,uint256 _onePriceRatio,uint256 _riskFactor,address _streamingProcessor) external initializer{
    ...
    function setQuadraticLiquidation(address _quadraticLiquidation) onlyGovernance external{
    ...
    function abortiveAuction(uint256 auctionId) external nonReentrant whenNotPaused{
        ...
        if(address(quadraticLiquidation) == address(0)){
            ...
            quadraticLiquidation.disposalNFT(_auctionInfo.bid,_auctionInfo.erc721Addr, _auctionInfo.tokenId,_auctionInfo.auctionToken);
        }
